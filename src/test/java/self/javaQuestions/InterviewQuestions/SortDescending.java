...
public class SortDescending {
    ...
    Inside the inner loop, I use an “if” condition.
    If the value in the index value according to first loop is smaller that the value according to the second loop,
    I assign that value to temp.
    Then I assign the second value to the first index. Next I assign the second value to temp.
    As loop runs, all values from the largest to smallest are sorted because of this swap.
